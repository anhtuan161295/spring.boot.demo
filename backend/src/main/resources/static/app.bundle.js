...
var UserController = function (_Component) {
  _inherits(UserController, _Component);

  function UserController(props) {
    _classCallCheck(this, UserController);

    var _this = _possibleConstructorReturn(this, (UserController.__proto__ || Object.getPrototypeOf(UserController)).call(this, props));
